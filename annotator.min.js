...
(function(f) {
    ...
    return function e(t, n, r) {
        ...
        30: [function(require, module, exports) {
            ...
            Editor.template = ['<div class="annotator-outer annotator-editor annotator-hide">', '  <form class="annotator-widget">', '    <ul class="annotator-listing"></ul>', '    <div class="annotator-controls">', '     <a href="#cancel" class="annotator-cancel">' + _t("Cancel") + "</a>", '      <a href="#save"', '         class="annotator-save annotator-focus">' + _t("Save") + "</a>", "    </div>", "  </form>", "</div>"].join("\n");
            Editor.options = {
                defaultFields: true
            };
        ...
        31: [function(require, module, exports) {
            ...
            Filter.html = {
                element: ['<div class="annotator-filter">', "  <strong>" + _t("Navigate:") + "</strong>", '  <span class="annotator-filter-navigation">', '    <button type="button"', '            class="annotator-filter-previous">' + _t("Previous") + "</button>", '    <button type="button"', '            class="annotator-filter-next">' + _t("Next") + "</button>", "  </span>", "  <strong>" + _t("Filter by:") + "</strong>", "</div>"].join("\n"),
        ...
        33: [function(require, module, exports) {
            (function(global) {
                ...
                function injectDynamicStyle() {
                    ...
                    var sel = "*" + ":not(annotator-adder)" + ":not(annotator-outer)" + ":not(annotator-notice)" + ":not(annotator-filter)";
                    var max = maxZIndex(util.$(global.document.body).find(sel).get());
                    max = Math.max(max, 1e3);
                    var rules = [".annotator-adder, .annotator-outer, .annotator-notice {", "  z-index: " + (max + 20) + ";", "}", ".annotator-filter {", "  z-index: " + (max + 10) + ";", "}"].join("\n");
        ...
        34: [function(require, module, exports) {
            (function(global) {
                ...
                exports.viewerExtension = function viewerExtension(viewer) {
                    if (!global.showdown || typeof global.showdown.Converter !== "function") {
                        console.warn(_t("To use the Markdown plugin, you must " + "include Showdown into the page first."))
                    }
